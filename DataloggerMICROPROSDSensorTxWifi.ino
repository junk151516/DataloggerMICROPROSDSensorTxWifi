...
#define sensor4Pin A7
#define sensor5Pin A4
#define sensor6Pin A5
#define wifiModuleEnablePin A3
#define resetPin 3
#define ledPin 10
...
void writeKarelDataOnSDWithComma(char byteWithCommaReceived){
  ...
  // Flag which turn the LED on to check if SD is working O.K
...
void writeMilliSecondsOnSD(void){
  ...
  // Flag which turn the LED on to check if SD is working good
  digitalWrite(ledPin, HIGH);
